...
function PhoneScreen({ coin, onBack, children }) {
  return (
    <div className="min-h-screen w-full flex flex-col items-center">
      {/* Full-width navbar */}
      <nav className="w-full sticky top-0 z-50 border-b border-[rgba(255,255,255,0.08)] bg-[#0a0e27]/90 backdrop-blur-xl">
      ...
      <div className="w-full flex-1 flex items-start justify-center px-3 py-6 sm:py-10">
        <div className="w-full max-w-sm sm:max-w-md rounded-3xl border border-[rgba(255,255,255,0.08)] bg-[#0a0e27] shadow-2xl overflow-hidden">
